...
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.BSPBranch;
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.BSPLeaf;
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.BSPNode;
...
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.MazeBuilder;
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.Seg;
import tjshrestha.cs301.cs.wm.edu.amazebytjshrestha.generation.Wall;
...
public class FirstPersonDrawer extends DefaultViewer {
	...
	public void redraw(MazePanel panel, StateGUI state, int px, int py, int view_dx, int view_dy, int walk_step, int view_offset, RangeSet rset, int ang) {	
		...
		//Log.v("FirstPersonDrawer:", "In First Person Drawer redraw?");
		this.rset = rset ;
